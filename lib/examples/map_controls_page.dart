...
class _MapControlsExampleState extends State<_MapControlsExample> {
  ...
  static const Point _point = Point(latitude: 41.326577, longitude: 69.228404);
  final animation =
          ...
          Expanded(
            ...
            cameraBounds: const CameraBounds(
                ...
                latLngBounds: BoundingBox(
                  northEast: Point(latitude: 42, longitude: 69.6),
                  southWest: Point(latitude: 41, longitude: 68.7),
                )),
