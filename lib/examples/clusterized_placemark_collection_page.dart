...
class _ClusterizedPlacemarkCollectionExampleState
  ...
  double _randomDouble() {
    return (50 - seed.nextInt(1000)) / 1000;
  }
                      ...
                      final mapObject = ClusterizedPlacemarkCollection(
                        ...
                        placemarks: [
                          PlacemarkMapObject(
                              ...
                              point: const Point(
                                  latitude: 41.334708, longitude: 69.170021),
                          ...
                          PlacemarkMapObject(
                              ...
                              point: const Point(
                                  latitude: 41.270148, longitude: 69.229599),
                              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                  image: BitmapDescriptor.fromAssetImage(
                                      'lib/assets/place.png'),
                                  scale: 1))),
                          PlacemarkMapObject(
                              ...
                              point: const Point(
                                  latitude: 41.375736, longitude: 69.256448),
                              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                  image: BitmapDescriptor.fromAssetImage(
                                      'lib/assets/place.png'),
                                  scale: 1))),
                      ...
                      setState(() {
                        mapObjects[mapObjects.indexOf(mapObject)] =
                          ...
                          PlacemarkMapObject(
                              mapId: const MapObjectId('placemark_2'),
                              point: const Point(
                                  latitude: 41.334562, longitude: 69.325447),
                              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                  image: BitmapDescriptor.fromAssetImage(
                                      'lib/assets/place.png'),
                                  scale: 1))),
                          PlacemarkMapObject(
                              mapId: const MapObjectId('placemark_3'),
                              point: const Point(
                                  latitude: 41.291274, longitude: 69.253853),
                              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                  image: BitmapDescriptor.fromAssetImage(
                                      'lib/assets/place.png'),
                                  scale: 1))),
                          PlacemarkMapObject(
                              ...
                              point: const Point(
                                  latitude: 41.281740, longitude: 69.183899),
                              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                  image: BitmapDescriptor.fromAssetImage(
                                      'lib/assets/place.png'),
                                  scale: 1))),
                        ...
                        final largeMapObject = ClusterizedPlacemarkCollection(
                          ...
                          placemarks: List<PlacemarkMapObject>.generate(
                            ...
                            return PlacemarkMapObject(
                                ...
                                point: Point(
                                    latitude: 41.315988 + _randomDouble(),
                                    longitude: 69.254091 + _randomDouble()),
                                icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                    image: BitmapDescriptor.fromAssetImage(
                                        'lib/assets/place.png'),
                                    scale: 1)));
